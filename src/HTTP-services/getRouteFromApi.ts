export const getRouteFromApi=(point1:string, point2:string,point3:string)=>{
    ...
    return fetch(`https://router.project-osrm.org/route/v1/driving/${newPoint1};${newPoint2};${newPoint3}?alternatives=true&geometries=polyline&overview=full&annotations=true` )
}